...
exports.SvgGeneratorService = void 0;
const common_1 = require("@nestjs/common");
let SvgGeneratorService = class SvgGeneratorService {
    generateLevelCard(username, level, xp, nextLevelXp, rank, coins) {
    ...
    generateProfileCard(username, level, xp, rank, coins, badges, vipStatus) {
        return `
...
exports.SvgGeneratorService = SvgGeneratorService;
exports.SvgGeneratorService = SvgGeneratorService = __decorate([
